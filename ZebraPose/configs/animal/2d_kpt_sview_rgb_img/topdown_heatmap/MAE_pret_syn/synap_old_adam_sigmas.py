...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/SynAP/annotations_99+3000 (SynAP)/ap10k-train-split1-only-syn.json',
    ...
    val=dict(
        type='AnimalAP10KDataset',
        ann_file=f'{data_root}/SynAP/annotations_99+3000 (SynAP)/ap10k-val-split1-only-syn.json',
        img_prefix=f'{data_root}/data/',
        data_cfg=data_cfg,
