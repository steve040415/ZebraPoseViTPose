...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/SPAC-NET/annotations_99real+3000syn/ap10k-train-split1-newnames.json',
    ...
    val=dict(
        type='AnimalAP10KDataset',
        ann_file=f'{data_root}/SPAC-NET/annotations_99real+3000syn/ap10k-val-split1-newnames.json',
        img_prefix=f'{data_root}/data/',
        data_cfg=data_cfg,
