...
data_root = '/media/ebonetto/WindowsData/pose_zebras_sw/all_about_zebras/ViTPose/data/apt36k'
data = dict(
    samples_per_gpu=64,
    workers_per_gpu=8,
    ...
    val=dict(
        type='AnimalAP10KDataset',
        ann_file=f'{data_root}/valid/valid_27_OZ_fixed.json',
    ...
    test=dict(
        type='AnimalAP10KDataset',
        ann_file=f'{data_root}/valid/valid_27_nozebras.json',
        img_prefix=f'{data_root}/valid/images/',
        data_cfg=data_cfg,
        pipeline=val_pipeline,
        dataset_info={{_base_.dataset_info}}),
