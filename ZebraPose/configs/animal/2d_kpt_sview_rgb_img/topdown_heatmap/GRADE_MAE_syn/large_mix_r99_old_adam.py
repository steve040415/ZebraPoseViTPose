...
model = dict(
    type='TopDown',
    pretrained='data/mae_pretrain_vit_large.pth',
    backbone=dict(
        type='ViT',
        img_size=(256, 192),
        patch_size=16,
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/train/train_99.json',
    ...
    val=dict(
        type='AnimalAP10KDataset',
        ann_file=f'{data_root}/valid/valid_99.json',
